...
public protocol DigitalSignatureVerifier {
    /**
     Verifies a blob of data with a supplied signature using the underlying verifying key in the specified access group.
     ...
     */
    func verify(for tag: String, data: Data, with signature: Data, _ accessGroup: String?) throws -> Bool
}
